...
from application.prompts_srs import build_test_case_user_prompt
...
# Lexical rerank on top of vector similarity distance (lower = better).
...
def _boosted_distance(
    ...
    *,
    ...
    """Lower is better. Subtract small bonuses when chunk text overlaps name/anchors."""
...
def _retrieve_merged_unique(
    ...
    *,
    ...
    """
    Run similarity search per query; keep each chunk once, using best (lowest) distance,
